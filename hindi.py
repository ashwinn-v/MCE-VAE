...
if __name__ == '__main__':
    ...
    mnist_SE2 = np.load('/content/trainingdata.npy')
    mnist_SE2_test = np.load('/content/testdata.npy')
    mnist_SE2_init = np.load('/content/trainingdata.npy')
    mnist_SE2_init_test = np.load('/content/testdata.npy')
